...
/*
Plugin Name: Classical Admin Footer Image
Plugin URI: https://bishalgc.com/secure-file-access/
Description: A simple way to generate secure link to the media file which can protect unauthorized access to the media files.
Version: 1.0
Author: Bishal GC
Author URI: https://bishalgc.com
Tags: files, secure ,file-security
License: GPL
